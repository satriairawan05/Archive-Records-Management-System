...
@section('app')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('perusahaan.update',$com->com_id) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group row">
                            <div class="col-6">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="com_name" placeholder="Masukan Nama Perusahaan/Organisasi" value="{{ old('com_name',$com->com_name) }}"
                            ...
                            <div class="col-6">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="com_alias" placeholder="Masukan Alias/Singkatan" value="{{ old('com_alias',$com->com_alias) }}"
                        ...
                        <div class="form-group row mt-3">
                            <div class="col-6">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="com_address" placeholder="Masukan Alamat" value="{{ old('com_address',$com->com_address) }}"
                            ...
                            <div class="col-6">
                                ...
                                <input type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="com_phone" placeholder="Masukan Phone Number" value="{{ old('com_phone',$com->com_phone) }}"

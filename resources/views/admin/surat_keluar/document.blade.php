...
<body>
    <div class="container mt-4">
        ...
        <div class="row mx-5 mt-2">
            <div class="col-6">
                <p style="margin-left: 60px; margin-bottom: 0;">Yth. {{ $surat->sk_tujuan }}</p>
                <p style="margin-left: 70px; margin-top: 0; margin-bottom: 0;">di - </p>
                <p style="margin-left: 80px;">{{ $surat->sk_tempat_tujuan }}</p>
            </div>
            <div class="col-6"></div>
        </div>
        <div class="row mx-5">
